...
class Humanize
    ...
    intcomma: (n, d=0) => @intComma n, d
    
    intComma: (number, decimals=0) => @formatNumber number, decimals
    ...
    truncatewords: (s, l) => @truncateWords s, l
    ...
    truncatenumber: (n, b=100, e='+') => @boundedNumber n, b, e
