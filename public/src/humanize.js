(function() {
  ...
  Humanize = (function() {
    ...
    Humanize.prototype.intword = function(number, charWidth, decimals) {
      if (decimals == null) {
        decimals = 2;
      }
      /*
    ...
    Humanize.prototype.compactInteger = function(input, decimals) {
    ...
    Humanize.prototype.intcomma = function(n, d) {
      if (d == null) {
        d = 0;
      }
    ...
    Humanize.prototype.intComma = function(number, decimals) {
      if (decimals == null) {
        decimals = 0;
      }
    ...
    Humanize.prototype.filesize = function(f) {
      return this.fileSize(f);
    };

    Humanize.prototype.fileSize = function(filesize) {
      var sizeStr;
    ...
    Humanize.prototype.formatNumber = function(number, precision, thousand, decimal) {
    ...
    Humanize.prototype.toFixed = function(value, precision) {
      var power;
      if (precision == null) {
    ...
    Humanize.prototype.normalizePrecision = function(value, base) {
    ...
    Humanize.prototype.ordinal = function(value) {
    ...
    Humanize.prototype.times = function(value, overrides) {
    ...
    Humanize.prototype.pluralize = function(number, singular, plural) {
    ...
    Humanize.prototype.truncate = function(str, length, ending) {
      if (length == null) {
        length = 100;
      }
      if (ending == null) {
    ...
    Humanize.prototype.truncatewords = function(s, l) {
      return this.truncateWords(s, l);
    };

    Humanize.prototype.truncateWords = function(string, length) {
      var array, i, result;
      array = string.split(" ");
      result = "";
      i = 0;
    ...
    Humanize.prototype.truncatenumber = function(n, b, e) {
      if (b == null) {
        b = 100;
      }
      if (e == null) {
    ...
    Humanize.prototype.boundedNumber = function(num, bound, ending) {
      var result;
      if (bound == null) {
        bound = 100;
      }
    ...
    Humanize.prototype.oxford = function(items, limit, limitStr) {
    ...
    Humanize.prototype.dictionary = function(object, joiner, separator) {
    ...
    Humanize.prototype.frequency = function(list, verb) {
      var len, str, times;
      if (!isArray(list)) {
        return;
      }
    ...
    Humanize.prototype.pace = function(value, intervalMs, unit) {
    ...
    Humanize.prototype.nl2br = function(string, replacement) {
      if (replacement == null) {
        replacement = '<br/>';
      }
    ...
    Humanize.prototype.br2nl = function(string, replacement) {
      if (replacement == null) {
        replacement = '\r\n';
      }
    ...
    Humanize.prototype.capitalize = function(string, downCaseTail) {
    ...
    Humanize.prototype.capitalizeAll = function(string) {
      return string.replace(/(?:^|\s)\S/g, function(a) {
        return a.toUpperCase();
      });
    };

    Humanize.prototype.titlecase = function(s) {
      return this.titleCase(s);
    };

    Humanize.prototype.titleCase = function(string) {
